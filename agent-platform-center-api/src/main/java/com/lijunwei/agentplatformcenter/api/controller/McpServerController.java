...
public class McpServerController {
    ...
    public McpServerController(AgentCatalogService agentCatalogService) {
        this.agentCatalogService = agentCatalogService;
    }

    @GetMapping
    public List<PlatformResource> listMcpServers() {
        return agentCatalogService.listMcpServers();
    }

    @PostMapping
    public PlatformResource createMcpServer(@Valid @RequestBody CreatePlatformResourceRequest request) {
        return agentCatalogService.createResource("mcp", request);
    }
}
