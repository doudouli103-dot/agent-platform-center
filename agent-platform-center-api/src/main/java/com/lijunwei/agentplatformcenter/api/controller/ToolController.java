...
public class ToolController {
    ...
    public ToolController(AgentCatalogService agentCatalogService) {
        this.agentCatalogService = agentCatalogService;
    }

    @GetMapping
    public List<PlatformResource> listTools() {
        return agentCatalogService.listTools();
    }

    @PostMapping
    public PlatformResource createTool(@Valid @RequestBody CreatePlatformResourceRequest request) {
        return agentCatalogService.createResource("tool", request);
    }
}
