...
public class PromptController {
    ...
    public PromptController(AgentCatalogService agentCatalogService) {
        this.agentCatalogService = agentCatalogService;
    }

    @GetMapping
    public List<PlatformResource> listPrompts() {
        return agentCatalogService.listPrompts();
    }

    @PostMapping
    public PlatformResource createPrompt(@Valid @RequestBody CreatePlatformResourceRequest request) {
        return agentCatalogService.createResource("prompt", request);
    }
}
